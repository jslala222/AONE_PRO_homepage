    ...
    <div className="pt-20 lg:pt-24 min-h-screen" style={{ backgroundColor: '#f9fafb' }}>
      ...
      <section className="py-12 bg-white border-b" style={{ borderColor: theme.colors.border }}>
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="text-3xl sm:text-4xl font-bold" style={{ color: theme.colors.text }}>이용약관</h1>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-3xl p-8 sm:p-12 border" style={{ borderColor: theme.colors.border, boxShadow: `0 4px 20px ${theme.colors.shadow}` }}>
            <div className="prose prose-lg max-w-none">
              <h2 className="text-2xl font-bold mt-8 mb-4" style={{ color: theme.colors.text }}>제 1 조 (목적)</h2>
              ...
              <h2 className="text-2xl font-bold mt-8 mb-4" style={{ color: theme.colors.text }}>제 2 조 (용어의 정의)</h2>
              ...
              <h2 className="text-2xl font-bold mt-8 mb-4" style={{ color: theme.colors.text }}>제 3 조 (결제 및 환불)</h2>
              <ul className="list-disc pl-6 space-y-2" style={{ color: theme.colors.textMuted }}>
              ...
              <h2 className="text-2xl font-bold mt-8 mb-4" style={{ color: theme.colors.text }}>제 4 조 (회사의 의무)</h2>
              <p className="leading-relaxed" style={{ color: theme.colors.textMuted }}>
                회사는 관련법과 본 약관이 금지하거나 미풍양속에 어긋나는 행위를 하지 않으며, 계속적이고 안정적으로 서비스를 제공하기 위하여 최선을 다하여 노력합니다.
              </p>

              <h2 className="text-2xl font-bold mt-8 mb-4" style={{ color: theme.colors.text }}>제 5 조 (서비스의 제공)</h2>
              <ul className="list-disc pl-6 space-y-2" style={{ color: theme.colors.textMuted }}>
              ...
              <h2 className="text-2xl font-bold mt-8 mb-4" style={{ color: theme.colors.text }}>제 6 조 (이용자의 의무)</h2>
              <ul className="list-disc pl-6 space-y-2" style={{ color: theme.colors.textMuted }}>
              ...
              <h2 className="text-2xl font-bold mt-8 mb-4" style={{ color: theme.colors.text }}>제 7 조 (면책)</h2>
              <ul className="list-disc pl-6 space-y-2" style={{ color: theme.colors.textMuted }}>
                <li>회사는 이용자의 서비스 이용 행위에 대하여 책임을 지지 않습니다.</li>
                <li>이용자가 제6조의 의무를 위반하여 발생한 문제에 대해 회사는 책임을 지지 않습니다.</li>
              </ul>

              <h2 className="text-2xl font-bold mt-8 mb-4" style={{ color: theme.colors.text }}>제 8 조 (관할 법원)</h2>
              <p className="leading-relaxed" style={{ color: theme.colors.textMuted }}>
